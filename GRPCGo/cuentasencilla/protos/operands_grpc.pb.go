...
type CalculatorClient interface {
	Add(ctx context.Context, in *Operands, opts ...grpc.CallOption) (*APIResponse, error)
}
...
func (c *calculatorClient) Add(ctx context.Context, in *Operands, opts ...grpc.CallOption) (*APIResponse, error) {
	out := new(APIResponse)
	err := c.cc.Invoke(ctx, "/protos.Calculator/Add", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CalculatorServer interface {
	Add(context.Context, *Operands) (*APIResponse, error)
...
func (UnimplementedCalculatorServer) Add(context.Context, *Operands) (*APIResponse, error) {
...
func _Calculator_Add_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protos.Calculator/Add",
	}
...
var Calculator_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "protos/operands.proto",
}
